...
def train_one_epoch(
    ...
    for batch in train_loader:
        ...
        alpha = alpha_params.alpha  # List[float], len = n_levels
...
def main():
    ...
    # Load training data
    from data.dataset import get_train_loader  # adjust to actual data module path

    train_loader = get_train_loader(
        args.dataset,
        batch_size=args.batch_size,
        return_item_embs=True,  # yields (user_seq, target_emb, neg_embs)
    )
