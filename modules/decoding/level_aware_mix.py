...
class LevelAwareHybridDecoding(BeamSearchStrategy):
    ...
    def expand(
        self,
        beams: Optional[Tensor],         # [B, k, h] or None at h=0
        ...
        decoder_hidden: Optional[Tensor] = None,  # [B*k, d_model] or [B, d_model] at h=0
    ...
    def _compute_partial_reconstruction(
        self,
        beams: Optional[Tensor],   # [B, k, h] — previously chosen tokens
